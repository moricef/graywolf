...
<style>
  ...
  :global(.rxt-popup-body) { font-family: var(--font-mono); }
  :global(.rxt-popup-heading) { display: block; margin-bottom: 8px; }
  :global(.rxt-popup-row + .rxt-popup-row) {
    border-top: 1px solid var(--map-overlay-border);
    margin-top: 8px;
    padding-top: 8px;
  }
  :global(.rxt-popup-metrics) {
